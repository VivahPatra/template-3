          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 my-5">
              <div className="text-center">
                <span className="font-display shimmer-text block" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', lineHeight: 1.5, padding: '0.15em 0' }}>{weddingData.brideName}</span>
              ...
              <div className="text-center">
                <span className="font-display shimmer-text block" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', lineHeight: 1.5, padding: '0.15em 0' }}>{weddingData.groomName}</span>
